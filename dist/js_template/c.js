...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function() { var T = new H.Template({code: function (c,p,i) { var t=this;t.b(i=i||"");if(t.s(t.f("stooges",c,p,1),c,p,0,12,31,"{{ }}")){t.rs(c,p,function(c,p,t){t.b("<b>");t.b(t.v(t.f("name",c,p,0)));t.b("</b>\r");t.b("\n" + i);});c.pop();}return t.fl(); },partials: {}, subs: {  }}, "{{#stooges}}\r\n<b>{{name}}</b>\r\n{{/stooges}}", H);return T.render.apply(T, arguments); };
